---
description: Performs a thorough code review covering bugs, security vulnerabilities,   performance, and best practices. Use when asked to "review", "check",   "audit code", or "look at this file". Works on any language.
---
